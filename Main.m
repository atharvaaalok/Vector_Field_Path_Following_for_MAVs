...
fig1_comps.p1 = plot(y_d, X_d, 'LineWidth', 2, 'Color', PS.Red1);
...
SAVE_MY_FIGURE(fig1_comps, 'Straight_Path_IC_plots_Vary_X_inf.png', 'small');
...
for n = 1: length(y0_list)
    ...
    fig2_comps.p(n) = plot(tRange, y{n}, 'LineWidth', 1.25, 'Color', PS.Blue1);
...
SAVE_MY_FIGURE(fig2_comps, 'Main_1_Vary_X_inf.png', 'small');
...
SAVE_MY_FIGURE(fig3_comps, 'Main_2_Vary_X_inf.png', 'small');
